...
Значения ширины ЯПФ до и после минимизации, а также коэффициенты ускорения для выбранных линейных участков из @tbl:tabl2 приведены в диаграммах на @fig:make5.

\vspace{7.5cm}

![Статистика распараллеливания линейных участков, приведённых в @tbl:tabl2](./images/png5.png){#fig:make5 width="5.8in"}
